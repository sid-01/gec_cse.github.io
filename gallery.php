...
<div class="carousel-item active">
  <img src="images\IMG-20181018-WA0007.jpg" class="d-block w-100" alt="...">
</div>
<div class="carousel-item">
  <img src="images\IMG_20180502_182032_169.jpg" class="d-block w-100" alt="...">
</div>
<div class="carousel-item">
  <img src="images\IMG-20180809-WA0014.jpg" class="d-block w-100" alt="...">
</div>
<div class="carousel-item">
  <img src="images\IMG_20170928_110839.jpg" class="d-block w-100" alt="...">
</div>
<div class="carousel-item">
  <img src="images\IMG-20190410-WA0020.jpg" class="d-block w-100" alt="...">
</div>
</div>
...
<p>
  ...
  <button class="btn btn-primary text-center " type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" style="margin-left:45%;width:10%;">
    See more
  </button>
</p>
<div class="collapse" id="collapseExample">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        <img src="images\IMG-20181018-WA0014.jpg" style="width:100%;margin-top:1rem" alt="">

      </div>
      <div class="col-lg-6">
        <img src="images\IMG-20181018-WA0016.jpg"   style="width:100%;margin-top:1rem" alt="">

      </div>
      <div class="row">
        <div class="col-lg-6">
          <img src="images\IMG-20181007-WA0007.jpg"   style="width:100%;margin-top:1rem" alt="">
        </div>
          <div class="col-lg-6">
            <img src="images\IMG-20190410-WA0079.jpg"  style="width:100%;margin-top:1rem" alt="">
          </div>
        </div>

        <div class="row">
          <div class="col-lg-6">
            <img src="images\IMG_20180306_140504.jpg"   style="width:100%;margin-top:1rem" alt="">
          </div>
            <div class="col-lg-6">
              <img src="images\IMG_20190525_163051.jpg"  style="width:100%;margin-top:1rem" alt="">
            </div>
          </div>

          <div class="row">
            <div class="col-lg-6">
              <img src="images\IMG_20191213_213403.jpg"   style="width:100%;margin-top:1rem" alt="">
            </div>
              <div class="col-lg-6">
                <img src="images\IMG_20190525_180636.jpg"  style="width:100%;margin-top:1rem" alt="">
              </div>
            </div>
  </div>
</div>
