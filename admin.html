...
<form action="index.php" method="post" style="width:60%;margin:auto;margin-top:3cm;border:2px solid lightgrey;padding:1.5cm;">

  <div class="form-group">
      <h3 style="color:red;margin-bottom:1cm" class="text-center"><b>Admin </b></h3>
